...
@section('title', 'Insert Pelanggan')
...
<form method="post" action="/customer">
    ...
    <div class="form-group row">
        <label for="code" class="col-sm-2 col-form-label">Kode Pelanggan<span style="color:red;">*</span></label>
        <div  class="col-sm-2">
    ...
    <div class="form-group row">
        <label for="name" class="col-sm-2 col-form-label" >Nama Pelanggan<span style="color:red;">*</span></label>
        <div  class="col-sm-2">
    ...
    <div class="form-group row">
        <label for="address" class="col-sm-2 col-form-label">Alamat Pelanggan<span style="color:red;">*</span></label>
        <div  class="col-sm-2">
