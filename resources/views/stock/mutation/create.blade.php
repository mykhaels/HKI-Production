...
<form method="post" action="/transfer-in">
    ...
    <div class="form-group row">
        <label for="code" class="col-sm-2 col-form-label">No Mutasi</label>
        <div  class="col-sm-2">
    ...
    <div class="form-group row">
        <label for="transaction_date" class="col-sm-2 col-form-label">Tanggal Mutasi</label>
        <div  class="col-sm-2">
    ...
    <div class="form-group row">
        <label for="productType" class="col-sm-2 col-form-label">Tipe Produk Asal</label>
        <div  class="col-sm-2">
        ...
        <button type="button" class="btn btn-primary col-md-2 offset-md-5" id="delete_row" float="right">
            Hapus data
        </button>
    </div>

    <table class="table" id="details_table_from">
        <thead>
            <tr>
    ...
    <div class="form-group row">
        <label for="productType" class="col-sm-2 col-form-label">Tipe Produk Tujuan</label>
        <div  class="col-sm-2">
            <select class="form-control" id="productType" name="production_type">
            <option value="1">Barang Jadi</option>
            <option value="2">Bahan Baku</option>
    ...
    <table class="table" id="details_table_to">
        <thead>
            <tr>
                <th scope="col">Kode-Nama Produk</th>
                <th scope="col">Qty</th>
...
<script>
    ...
    $("#add_row").click(function(e){
        e.preventDefault();
        $('#details_table_from').append(row);
        $('#details_table_to').append(row);
    });
