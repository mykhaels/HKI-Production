...
<form method="post" action="/purchase-order">
    ...
    <div class="form-group row">
        ...
        <div  class="col-sm-2">
            <select class="form-control" id="productType" name="product_type" readonly>
...
<div class="form-group d-flex justify-content-end">
    ...
    <input type="input" class="form-control col-md-2" id="subtotal-input" name="subtotal" readonly value="{{ $purchaseOrder->subtotal }}">
</div>
<div class="form-group d-flex justify-content-end">
    <label for="ppn-input" class="col-md-1 m-1">PPN</label>
    <input type="input" class="form-control col-md-2" id="ppn-input" name="ppn" readonly value="{{ $purchaseOrder->ppn }}">
</div>
<div class="form-group d-flex justify-content-end">
    <label for="total-input" class="col-md-1 m-1">Total</label>
    <input type="input" class="form-control col-md-2" id="total-input" name="total" readonly value="{{ $purchaseOrder->total }}">
</div>
